                ...
                <form wire:submit.prevent="submit" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <img id="imgPreview" style="width: 200px; height: 200px; object-fit: contain;" src="{{ asset('storage/'.$product->img_path) }}" alt="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $product->name }}" class="form-control" id="name" placeholder="Название товара">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" value="{{ $product->price }}" class="form-control" id="price" placeholder="Цена товара">
